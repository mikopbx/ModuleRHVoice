 ...
 */
namespace Modules\ModuleRHVoice\App\Controllers;
...
{
    private $moduleUniqueID = 'ModuleRHVoice';
    private $moduleDir;
    ...
    public function indexAction(): void
    {
        ...
        $footerCollection->addJs("js/cache/{$this->moduleUniqueID}/modulerh-voice-index.js", true);

        $headerCollectionCSS = $this->assets->collection('headerCSS');
        $headerCollectionCSS->addCss("css/cache/{$this->moduleUniqueID}/modulerh-voice.css", true);
    ...
    public function saveAction() :void
    {
        ...
        $record = ModuleRHVoice::findFirst();

        if ($record === null) {
            $record = new ModuleRHVoice();
        }
        $this->db->begin();
